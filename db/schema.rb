...
ActiveRecord::Schema.define(version: 2020_11_24_154423) do
  ...
  create_table "carditems", force: :cascade do |t|
    t.bigint "item_id"
    t.bigint "cart_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cart_id"], name: "index_carditems_on_cart_id"
    t.index ["item_id"], name: "index_carditems_on_item_id"
  end
